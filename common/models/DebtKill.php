...
/**
 * This is the model class for table "{{%debt_kill}}".
 *
 * @property int $id
 * @property int|null $order_id
 * @property float|null $debt_price
 ...
 */
class DebtKill extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['order_id', 'created_at', 'updated_at', 'created_by', 'updated_by'], 'integer'],
            [['debt_price'], 'number'],
    ...
    public function attributeLabels()
    {
        return [
            ...
            'debt_price' => Yii::t('app', 'Debt Price'),
